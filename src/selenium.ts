...
export const runSelenium = async () => {
    ...
    try {
        ...
        const trends = await driver.findElements(By.css("div[aria-label='Timeline: Trending now'] div[role='link']"));
        ...
        for (let trend of trends) {
            try {
                 let ot;
                if (i == 0) {
                    ot = await trend.findElement(By.css("span"));
                } else {
                    ot = await trend.findElement(By.css("span[dir='ltr']"));
                } 
